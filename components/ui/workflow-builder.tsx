...
const initialNodes: WorkflowNode[] = [
  {
    ...
    description: "Secure upload with encryption",
    icon: Webhook,
    color: "emerald",
    position: { x: 50, y: 100 },
  },
  {
    id: "node-2",
    type: "action",
    title: "Classification Scan",
    description: "PII and sensitivity detection",
    icon: Settings,
    color: "amber",
  ...
  },
  {
    ...
    description: "Local model indexing",
    icon: Database,
    color: "blue",
  ...
  },
  {
    ...
    type: "action",
    title: "LLM Inference",
    description: "Llama 3 70B on-premise",
    icon: Zap,
    color: "indigo",
  ...
  },
  {
    ...
    type: "action",
    title: "Audit Log",
    description: "Immutable query tracking",
    icon: Mail,
    color: "purple",
