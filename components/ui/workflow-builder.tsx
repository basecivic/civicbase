...
const initialNodes: WorkflowNode[] = [
  {
    ...
    type: "trigger",
    title: "Database Query",
    description: "Pull records from legacy system",
    icon: Database,
    color: "blue",
    position: { x: 50, y: 100 },
  },
  {
    ...
    type: "action",
    title: "Policy Check",
    description: "Apply compliance rules",
    icon: Settings,
    color: "amber",
  ...
  },
  {
    ...
    type: "action",
    title: "AI Analysis",
    description: "Extract insights with LLM",
    icon: Zap,
    color: "indigo",
  ...
  },
  {
    ...
    type: "condition",
    title: "Content Scan",
    description: "Verify no sensitive data",
    icon: Settings,
    color: "amber",
  ...
  },
  {
    ...
    type: "action",
    title: "Distribute",
    description: "Deliver to stakeholders",
    icon: Webhook,
    color: "emerald",
